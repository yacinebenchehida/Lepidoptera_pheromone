...
if [ "$NUM_SEQ" -gt 5 ]; then
    iqtree2 -s $RES_PATH/fasta_${PHE}_${COUNTER}_nt_trim_nt_trimmed_unique_seq_sp.aln -m MFP -B 1000 -nt 8 --prefix $RES_PATH/${PHE}_${COUNTER}
    ...
    iqtree2 -s $RES_PATH/fasta_${PHE}_${COUNTER}_nt_trimmed_unique_seq_sp.aln -m MFP -nt AUTO --prefix $RES_PATH/${PHE}_${COUNTER}
    Rscript ./plot_tree.R --tree $RES_PATH/${PHE}_${COUNTER}.treefile --prefix $RES_PATH/${PHE}_${COUNTER}
    echo TREE FOR ${PHE} ${COUNTER} BUILT
else
